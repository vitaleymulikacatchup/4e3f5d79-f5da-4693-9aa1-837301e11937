...
export const metadata: Metadata = {
  ...
  description: "Experience the finest artisan breads, pastries, and confections crafted with traditional methods and premium ingredients. Fresh baked daily.",
  keywords: "artisan bakery, fresh bread, pastries, sourdough, croissants, local bakery",
  openGraph: {
    title: "Artisan Bakery - Fresh Baked Daily",
    description: "Experience the finest artisan breads, pastries, and confections crafted with traditional methods.",
    siteName: "Artisan Bakery",
    type: "website",
    images: [
      {
